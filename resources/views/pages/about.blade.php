        ...
        <div class="relative px-4 sm:px-8 lg:px-12">
            <div class="mx-auto max-w-2xl lg:max-w-5xl">
                <div class="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
                    <div class="lg:pl-20">
                        <div class="max-w-xs px-2.5 lg:max-w-none"><img alt="" loading="lazy" width="800" height="800" decoding="async" data-nimg="1" class="aspect-square rotate-3 rounded-2xl bg-zinc-100 object-cover dark:bg-zinc-800" sizes="(min-width: 1024px) 32rem, 20rem" srcset="{{ '/storage/'.get_setting('logo') }}" style="color: transparent;"></div>
                    </div>
                    <div class="lg:order-first lg:row-span-2">
                        <h1 class="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">{{ get_setting('aboutTitle') }}</h1>
                        <div class="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">{!! str(get_setting('aboutDescription'))->sanitizeHtml() !!}</div>
                    </div>
                    <div class="lg:pl-20">
                        <ul role="list">
                            <li class="mt-4 flex">
