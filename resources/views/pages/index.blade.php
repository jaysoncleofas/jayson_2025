        ...
        <div class="mx-auto grid max-w-xl grid-cols-1 gap-y-20 lg:max-w-none lg:grid-cols-2">
          <div class="flex flex-col gap-16">
            ...
            <article class="group relative flex flex-col items-start">
              <h2 class="text-base font-semibold tracking-tight text-zinc-800 dark:text-zinc-100">
                ...
                <div><span class="relative z-10">{{ $project->title }}</span></div>
              </h2>
              <div class="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">{!! str( $project->description)->sanitizeHtml() !!}</div>
              <a  href="{{ $project->site_url }}" target="_blank" aria-hidden="true" class="relative z-10 mt-4 flex items-center text-sm font-medium text-teal-500">
                View Website
          ...
          <div class="space-y-10 lg:pl-16 xl:pl-24">
            ...
            <form action="/thank-you" class="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
              ...
              </svg><span class="ml-3">Contact me</span></h2>
